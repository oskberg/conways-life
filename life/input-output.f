...
: MAKE-TEST-FILE                                  { Create a test file to read / write to  }
  s" C:\Users\Oskar\Desktop\conways-life\conways-life\output\210128-opt-10.csv" r/w create-file drop  { Create the file                        } 
...
: OPEN-TEST-FILE                                  { Open the file for read/write access    }
  s" C:\Users\Oskar\Desktop\conways-life\conways-life\output\210128-opt-10.csv" r/w open-file drop    { Not needed if we have just created     }
